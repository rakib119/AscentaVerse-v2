...
class AamarPayController extends Controller
{
    ...
    public function success(Request $request)
    {
        ...
        if(!$info){
            return redirect()->route('social.home')->with('page_error','Payment request not found, please try again later.');
        }
        ...
        return redirect()->route('social.home', ['payment_status' => 'success']);
    ...
    public function fail(Request $request)
    {
        ...
        $info->save();
        Session::forget('package_info');
        return redirect()->route('social.home')->with('page_error','Payment failed, please try again later.');
    }

    public function cancel()
    {
        Session::forget('package_info');
        return redirect()->route('social.home')->with('page_error','Payment cancled, please try again later.');
    }
}
